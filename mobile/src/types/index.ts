...
export type RideState = 'idle' | 'comparing' | 'riding' | 'finished';

export interface RideStats {
  startTime: Date;
  endTime?: Date;
  stopsVisited: StopPoint[];
  peakRiskScore: 'green' | 'yellow' | 'red';
  exposureDegreesMin: number;  // °C·min cumulative exposure
}
